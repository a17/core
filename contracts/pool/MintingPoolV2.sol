 ...
 */
abstract contract MintingPoolV2 is IPool, Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    // Staked token
    IERC20MintableBurnable public stakedToken;
    ...
    function __MintingPool_init(
        ...
        IERC20MintableBurnable _stakedToken,
